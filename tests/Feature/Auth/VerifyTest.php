...
class VerifyTest extends TestCase
{
    ...
    /** @test */
    public function cannot_verify_incorrect_user_id(): void
    {
        [$user] = $this->prepare();
    ...
    /** @test */
    public function cannot_verify_incorrect_verification_token(): void
    {
        [$user] = $this->prepare();
    ...
    /** @test */
    public function cannot_verify_verified_user(): void
    {
        [$user] = $this->prepare();
