...
class RoleSelectTest extends TestCase
{
    ...
    /** @test */
    public function it_displays_role_description(): void
    {
        [$field, $user] = $this->prepare();
    ...
    /** @test */
    public function it_fills_database_with_role_value(): void
    {
        [$field, $user] = $this->prepare();
    ...
    /** @test */
    public function it_removes_role_from_database(): void
    {
        [$field, $user] = $this->prepare();
