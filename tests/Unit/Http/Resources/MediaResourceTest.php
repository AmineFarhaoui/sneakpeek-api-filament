...
class MediaResourceTest extends TestCase
{
    ...
    /** @test */
    public function to_array_image(): void
    {
    ...
    /** @test */
    public function to_array_image_force(): void
    {
        // Make sure the media is an image.
        [$media] = $this->prepare('image');
    ...
    /** @test */
    public function is_not_image(): void
    {
        // Make sure the media is not an image.
        [$media] = $this->prepare();
    ...
    /** @test */
    public function get_url_s3(): void
    {
